...
import com.example.dictionaryapp.feature_dictionary.presentation.dictionary_screen.components.WordInfoItem
...
fun DictionaryScreen(
    ...
    LaunchedEffect(key1 = true ){
        viewModel.eventFlow.collectLatest { event ->
            when(event){
                is DictionaryScreenViewModel.UiEvent.ShowSnackBar -> {
